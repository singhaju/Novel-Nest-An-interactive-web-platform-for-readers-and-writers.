...
VALUES
(2001, 'Pride and Prejudice', 'A classic romance novel that follows the spirited Elizabeth Bennet as she navigates love, family, and social expectations in Regency-era England.', '/pictures/pride-and-prejudice.jpg', '["romance", "classic", "regency"]', 'COMPLETED', NOW(), 150230, 12500, 4.95, 101),
(2002, 'Dune', 'Set in the distant future, this sci-fi epic follows Paul Atreides as he becomes embroiled in the politics of the desert planet Arrakis and the struggle for the precious spice melange.', '/pictures/dune.webp', '["sci-fi", "epic", "fantasy"]', 'COMPLETED', NOW(), 210500, 18200, 4.98, 102),
(2003, 'The Hobbit', 'The adventure of hobbit Bilbo Baggins, who is swept into an epic quest to reclaim treasure guarded by a dragon in Middle-earth.', '/pictures/the-hobbit.jpg', '["fantasy", "adventure", "classic"]', 'COMPLETED', NOW(), 320000, 25000, 4.99, 103),
(2004, 'To Kill a Mockingbird', 'Told through the eyes of Scout Finch, this novel explores the irrationality of adult attitudes towards race and class in the American South.', '/pictures/to-kill-a-mockingbird.jpg', '["classic", "fiction", "southern-gothic"]', 'COMPLETED', NOW(), 180450, 15300, 4.96, 104),
(2005, 'Nineteen Eighty-Four', 'A chilling dystopian novel set in Airstrip One, where the totalitarian Party controls every aspect of human existence through surveillance and propaganda.', '/pictures/nineteen-eighty-four.jpg', '["dystopian", "sci-fi", "classic"]', 'COMPLETED', NOW(), 255000, 21000, 4.97, 105)
